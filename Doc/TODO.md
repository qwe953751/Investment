...
| 16 | [市場切換（台股／美股／日股／韓股／加密貨幣；日韓最高權限入口）](#todo-16) | 🟡 2026-09-23 修復日韓盤中快照超時即被丟棄、收盤後不能手動檢視、盤中仍顯示交易日選擇器，以及 Yahoo 成交排行每五分鐘高頻觸發的問題；本機 .NET 549/549、Node 146/146 通過。日韓日線與 `jp`／`kr` 契約、Storage 發布仍有效；JP 9/23 休市，下一日本交易日再實際驗收新快照。其餘市場切換產品議題仍見下方 |
...
**2026-09-23 日韓盤中顯示／更新修復：** 快照完整性仍拒絕未來日期、latest／snapshot 不一致及缺核心資料；但年齡超過 20 分鐘只標示延遲，不再刪除最後一份有效快照。手動切到盤中可在收盤後檢視最後成功快照及其真實交易日／時間；日韓盤中隱藏日期選擇器並清掉舊日期。總覽維持每 5 分鐘，Yahoo 成交排行改為每 20 分鐘最多嘗試一次，失敗也節流。本機 .NET 549/549、Node 146/146 通過；push／正式網站發布尚待本輪後續驗證，JP 新快照待 9/24 開市觀察。
