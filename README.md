...
本輪另把美股／日股／韓股的「成交金額前 20」接入正式資料契約：排行列必須由資料源明確標記，前 20、日漲跌與年初至今漲跌由 C# 計算，前端採左 1～10、右 11～20 的雙欄排列，點擊列可開最近三個月 K 線。現有市場總覽快取尚未含全市場排行候選，因此正式資料沒有時顯示資料不足，不以指數／產業代表或本機示意列補值；本輪網站不發布。
