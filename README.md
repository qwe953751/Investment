...
本次「異常鈴鐺、手機盤中新鮮度、颱風假早退」提交為 `34f8717`（2026-08-23）；GitHub Pages 重新發布的完整快照版本為 `1787492693`（最新交易日 2026/08/21）。異常訊息改由 Supabase 的 `site_alerts` 供給，發佈失敗時線上快照雖然是舊的，鈴鐺仍讀得到當下的狀況。
這一版已完成並驗收：
