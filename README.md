...
| 在另一台裝置上要裝什麼、要什麼權限、接手時先確認什麼 | [Doc/開發環境.md](Doc/開發環境.md) |
| 主力機到底裝了哪些套件、每個用到什麼權限（接手時逐項對照） | [Doc/環境盤點.md](Doc/環境盤點.md) |
| 最近發布了什麼版本、快照版本號是多少 | [Doc/完成進度.md](Doc/完成進度.md#歷次發布版本) |
...
歷次發布的提交與快照版本記在 [Doc/完成進度.md](Doc/完成進度.md#歷次發布版本)，
其他裝置接手步驟記在 [Doc/開發環境.md](Doc/開發環境.md#接手既有進度時先確認的四件事)。
