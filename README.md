...
- 向前還原權息的 OHLC 與 MA5／MA20／MA60／MA240。
- K 棒上漲紅、下跌綠；MA5 藍、MA20 橘、MA60 粉、MA240 紫，並以前一交易日收盤判斷漲跌。
...
均線顏色遵循常用 APP 色票：MA5 藍、MA20 橘、MA60 粉、MA240 紫；
K 棒上漲紅、下跌綠、平盤灰。網站只繪製這四條均線，不加入 10MA／120MA。
...
| 欄位 | 內容 | 算法 |
|---|---|---|
| 營收增減 | 上下兩行，YOY 與 MOM | 跟去年同月比、跟上個月比。點這一欄以 **YOY** 排序 |
...
**營收不進靜態快照**，網頁直接讀 Supabase 的 `revenue_latest`：
